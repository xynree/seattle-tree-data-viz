  ...
  return (
    <div className="flex gap-2 ">
      <button
        ...
        className="w-full flex min-w-18 md:w-full bg-white p-2.5 rounded-xl shadow-md z-10 hover:bg-gray-100 transition-colors items-center justify-center text-blue-600"
