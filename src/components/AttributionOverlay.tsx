  ...
  return (
    <div className="text-sm flex items-center gap-2 bg-white shadow-sm absolute bottom-4 left-4 p-2 px-3 rounded-lg z-10">
      ...
      <div className="flex gap-2 text-gray-700">
        ...
        {/* Website */}
        <a target="_blank" rel="noopener noreferrer" href="https://www.xinrui.work" className="w-4">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 -960 960 960" width="20px" fill="currentColor"><path d="m332-264 148-113 148 113-56-182 148-106H538l-58-192-58 192H240l148 106-56 182ZM480-96q-79 0-149-30t-122.5-82.5Q156-261 126-331T96-480q0-80 30-149.5t82.5-122Q261-804 331-834t149-30q80 0 149.5 30t122 82.5Q804-699 834-629.5T864-480q0 79-30 149t-82.5 122.5Q699-156 629.5-126T480-96Zm0-72q130 0 221-91t91-221q0-130-91-221t-221-91q-130 0-221 91t-91 221q0 130 91 221t221 91Zm0-312Z" /></svg>
        </a>

        {/* Instagram */}
        <a target="_blank" rel="noopener noreferrer" href="http://instagram.com/xynree" className="ml-1 w-5">
          <svg
          ...
          >
            ...
            <path
              stroke-linecap="round"
              stroke-linejoin="round"
              d="M17.25 6.75a.75.75 0 100-0.0.75.75 0 000 1.5z"></path>
          </svg>
        </a>

        {/* Github */}
        <a target="_blank" rel="noopener noreferrer" href="https://github.com/xynree" className="w-5">
